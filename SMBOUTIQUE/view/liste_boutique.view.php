    ...
    $active_boutique = ($current_page == 'liste_boutique.php') ? 'active' : '';
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Liste des Supermarchés</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                 ...
                 <div class="col-xl-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="unite.php" class="btn btn-outline-primary btn-block <?= $active_unit; ?>">Unité</a>
            ...
            button.addEventListener('click', function(event) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location.href = 'supprimer_boutique.php?id=' +
