        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Création de Boutique</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-md-10 col-xm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                             <?php if (isset($boutique->errors) and !empty($boutique->errors)) : ?>
                                    <div class='alert alert-danger'>
                                        <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
                                        <?php foreach ($boutique->errors as $error) : ?>
                                            <?= $error ?> <br>
                                        <?php endforeach ?>
                                    </div>
                                <?php endif ?>
                            <form method="POST" action="" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="form-group col-lg-6">
                                        <label><span class="text-danger">*</span> Nom de la boutique</label>
                                        <input type="text" name="nom" value="<?= $boutique->get_valeur_input('nom') ?>" class="form-control">
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label><span class="text-danger">*</span>quartier</label>
                                        <input type="text" name="quartier" value="<?= $boutique->get_valeur_input('quartier') ?>" class="form-control">
                                    </div>
                                </div>
                                <div class="row mt-5">
                                    ...
                                    <div class="col-xl-6 col-md-10 col-xs-12">
                                        <div class="form-group">
                                            <a href="liste_boutique.php" class="btn btn-info form-control">Liste des boutiques</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
