...
ON fournisseur.id_fournisseur=commande_fournisseur.id_fournisseur WHERE id_commande_fournisseur=$reception LIMIT 1");
...
ON tbl_product.id=ligne_commande.id WHERE ligne_commande.quantite>ligne_commande.qte_livre AND ligne_commande.id_commande_fournisseur=$reception" );  
    ...
    <main id="main" class="main">
         <div class="pagetitle">
            ...
            <nav>
                ...
                <li class="breadcrumb-item active">acquisition de la reception</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        <div class="card info-card sales-card">
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-4">
                        <h5 class="card-title">&emsp;info sur la commande N°
                            <?=$commandeinfo['reference']?></h5>
                    </div>
                    <div class="col-4">
                ...
                <section class="section mt-5">
                    <div class="row">
                                                ...
                                                <div class="form-group">
                                                    <td>
                                                        ...
                                                        <input class="form-control" type="hidden" name="id_ligne[]"
                                                            value="<?=$affiche->id_ligne;?>" readOnly>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-md-10 col-xs-12 mt-3">
                                <div class="form-group">
                                    <a href="liste_commande_four.php" class="btn btn-info form-control "> Liste des commandes fournisseurs</a>
                                </div>
                            </div>
                        </div>
                </section>
