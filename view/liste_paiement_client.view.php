    ...
    <main id="main" class="main">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Paiements clients</li>
            ...
            deleteButtons.forEach(function (button) {
                button.addEventListener('click', function (event) {
                    ...
                    // Obtenez l'ID à partir de l'attribut "id" du bouton
                     var paiementId = button.getAttribute('data-paiecl-id');
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            window.location.href = 'supprimer_paiement_client.php?id=' + paiementId + '&confirm=true';
                        }
                    });
                });
            });
