    ...
    <main id="main" class="main">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">detail du reception</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        <div class="card info-card sales-card">
            <div class="card-header">
                <div class="row">
                    <div class="col-4">
                        <h5 class="card-title">&emsp;info sur la commande N° <?=$receptioninfo['reference']?></h5>
                    </div>
                    <div class="col-4">
                        <h5 class="card-title">&emsp; Fournisseur:
                            <?=$receptioninfo['nom_fournisseur'].' '.$receptioninfo['prenom_fournisseur']?>
                    </div>
                    <div class="col-4">
                        <h5 class="card-title">&emsp; Date de commande:
                            <?=date_format(date_create($receptioninfo['date_de_commande']), 'd-m-Y H:i:s') ?>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4">
                            <div class="card text-left">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label>Référence de la reception </label>
                                        <input type="text" name="ref" class="form-control" id=""
                                            value="<?=$receptioninfo['recept_ref']?>" readOnly>
                                    </div>
                                    <div class="form-group mt-3">
                                        <label>Date de la reception </label>
                                        <input type="datetime-local" name="dat" class="form-control"
                                            value="<?=$receptioninfo['date_reception']?>" readOnly>
                                    </div>
                                    <div class="form-group  mt-5">
                                        <a href="liste_reception.php" class="btn btn-primary">
                                            Liste Des reception
                                        </a>
                                    </div>
                                </div>
