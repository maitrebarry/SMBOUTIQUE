...
<?php require_once('envoie_paiement_client.php'); ?>
                ...
                <section class="section mt-5">
                    <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <td>
                                                        <input class="form-control" type="texte" name="mp"
                                                            value="<?= $commandeinfo['paie'] ?>" readOnly>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input class="form-control" type="number" name="map"
                                                            value="<?= $commandeinfo['total'] - $commandeinfo['paie'] ?>"
                                                            min="0">
                                                    </td>
                                            </tr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-md-10 col-xs-12 mt-3">
                                <div class="form-group">
                                        <a href="liste_commande_client.php" class="btn btn-success form-control">Liste des commandes</a>
                                </div>
                            </div>
                        </div>
                </section>
